...
from app.routes import grid, grid_edge, grid_import, grid_node, workspace
...
app = FastAPI(
    title="SGMS Workspace Grid Modelling  Microservice API",
    version="1.0.0",
    lifespan=lifespan,
)
...
app.include_router(grid_node.router, prefix="/api/v1")
app.include_router(grid_edge.router, prefix="/api/v1")
app.include_router(grid_import.router, prefix="/api/v1")
